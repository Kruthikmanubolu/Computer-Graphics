...
{ 
	...
	// Calculate the wriggling movement:
	// uAmp: amplitude of the wave
	// uSpeed * uTime: controls wave propagation over time
	// uFreq * vert.z: controls the number of waves along the z-axis
